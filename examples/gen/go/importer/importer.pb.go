...
//     whose Go package is matched by the --exclude_packages glob
//     `google.golang.org/protobuf/types/known/*`, so it is also treated as
//     "concrete pointer, no AsConst" in singular / repeated / map positions.
//     This doubles as the reason WKTs must be excluded today: they ship
//     without any *_Const / AsConst of their own, and the glob lets one
//     line cover every WKT subpackage at once.
...
type Envelope struct {
	...
	// --exclude_packages=google.golang.org/protobuf/types/known/* glob, so
